        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-5 col-md-5 col-lg-8">
                <ul id="sparks" class="">
                    ...
                    <li id="makepdf"> <a href="add-email.php"><button class="btn btn-success" ">Add new Email</button> </li>
                    ...
                    function makepdf() {
                        ...
                        $.ajax({
                            ...
                            success: function (response)
                            {
                                ...
                                document.getElementById("emailclient").innerHTML = '<button class="btn btn-success" onclick="emailclient();">Email Client</button>';
                    ...
                    function emailclient() {
                        ...
                        $.ajax({
                            ...
                            success: function (response)
                            {
                                ...
                                alert("email Has been sent to grindstore lawyers");
                            }
                        });
                                    ...
                                    <tbody>
                                        ...
                                        if ($rows != "") {
                                            foreach ($rows as $row) {
                                                ...
                                                echo '<tr><td>' . $website . '</td><td>' . $name . '</td><td>' . $email . '</td><td> <a href = "edit.php?id=' . $id . '"><span class = "fa fa-edit"></span></a></td> <td><a href = "delete.php?id=' . $id . '" onclick="return confirm(' . "'Are you sure you want delete'" . ');"><span class = "fa fa-remove"></span></a></td></tr>';
    }
                                        }
                                        ?>
                                    </tbody>
