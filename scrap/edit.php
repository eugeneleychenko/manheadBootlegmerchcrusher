                                    ...
                                    <form id="checkout-form" class="smart-form" action="" method="post"  >
                                        ...
                                        <fieldset>
                                            ...
                                            if (isset($_POST['email'])) {
                                                ...
                                                include 'santo/update.php';
                                                if (sqlupdate("contacts", $columns, "id=$id"))
                                            ...
                                            <div class="row">
                                                <section class="col col-6">
                                                    <label class="input"> <i class="icon-prepend fa fa-user"></i>
                                                        <input type="text" name="name" placeholder="Name" required value="<?php
                                                        if ($rows != "") {
                                                            echo $rows['name'];
}
                                                        ?>">
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="row">
                                                <section class="col col-6">
                                                    <label class="input">
                                                        <select name="website" id="website" required class="form-control">
                                                            <option value="">--Choose website--</option>
                                                            <option value="impericon">impericon</option>
                                                            <option value="grindstore">grindstore</option>
                                                            ...
                                                            <option value="redbubble">redbubble</option>
                                                                                                ...
                                                                                                <?php
                                                echo '<script>
 document.getElementById("website").value="' . $rows['website'] . '"
</script>';
                                                ?>
                                            </div>
                                        </fieldset>
