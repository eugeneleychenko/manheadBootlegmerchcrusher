            ...
            <nav>
                ...
                <ul>  <li> <a
                        ...
                        <li><a
                                ...
                                >
                                <i class="fa fa-lg fa-fw fa-table"></i>
                                <span class="menu-item-parent">Browse data</span>
                                        ...
                                        View etsy<span class="badge inbox-badge bg-color-greenLight"><?php echo getcount("select * from datas where website='etsy' "); ?></span>

                                    </a></li>
                                
                                
                                <li><a
                                        href="viewredbubble.php"

                                        title="View redbubble"
                                        >

                                        View redbubble<span class="badge inbox-badge bg-color-greenLight"><?php echo getcount("select * from datas where website='redbubble' "); ?></span>
                    ...
                    <li><a
                            ...
                            >
                            <i class="fa fa-lg fa-fw fa-table"></i>
                            <span class="menu-item-parent">Manage Contacts </span>
                    ...
                    <li><a
                            ...
                            >
                            <i class="fa fa-lg fa-fw fa-table"></i>
                            <span class="menu-item-parent">Clear Database</span>
                                    ...
                                    Clear DB <span class="badge inbox-badge bg-color-greenLight"><?php echo getcount("select * from datas "); ?></span>
