...
<div id="main" role="main">
    ...
    $subject = mysql_real_escape_string($_POST['mailsubject']);
    $content = mysql_real_escape_string($_POST['mailcontent']);
     $query = "UPDATE mailcontent SET mailsubject='$subject',mailcontent='$content' WHERE id=1";
    mysql_query($query);
                                            ...
                                            <div class="row">
                                                <section class="col col-6">
                                                    <label class="input"> <i class="icon-prepend fa fa-envelope-o"></i>
                                                        <input type="text" name="mailsubject" placeholder="Email subject" required value="<?php
                                                               $id = 1;
                                                        $query = "select * from `mailcontent` where id = $id ";
$rows = sqlfetchs($query);
                                                        if ($rows != "") {
                                                            echo $rows['mailsubject'];
                                                               }
                                                        ?>">
                                                    </label>
                                                </section>
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="row">
                                                <section class="col col-6">
                                                    Content: <br>
                                                    <textarea rows="20" cols="150" name="mailcontent" id=""><?php
                                                        if ($rows != "") {
                                                            echo $rows['mailcontent'];
                                                        }
                                                        ?></textarea>
                                                    </label>
                                                </section>
