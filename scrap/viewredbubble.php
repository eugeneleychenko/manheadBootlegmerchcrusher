...
<?php
$query = "select * from `datas` where website='redbubble'";
?>
<!-- MAIN PANEL -->
                                    ...
                                    <tbody>
                                        ...
                                        if ($rows != "") {
                                            foreach ($rows as $row) {
                                                ...
                                                echo '<tr><td>' . $title . '</td><td>' . $link . '</td><td><a href="'. $image .'" class="search-list-image"><img class="" src = "' . $image . '" alt = "" width = "100"></a></td><td>' . str_replace("+", " ", $brand) . '</td><td>' . $date . '</td></tr>';
                                            }
                                        }
                                        ?>
                                    </tbody>
